   ...
   public static final Map<String, String[]> GROUP_ITEMS = Collections.unmodifiableMap(new LinkedHashMap<>() {
      {
         ...
         put("Manager", new String[] { "^manager\\..*(color|style|bottom|top|background|field|glyph)$"});
         put("Console", new String[] { "^console\\..*(color|style|bottom|top|background|field|glyph)$"});
         put("Errors", new String[] { "^errors\\..*(color|style|bottom|top|background|field|glyph)$"});
         put("Header", new String[] { "^header\\..*(color|style|bottom|top|background|field|glyph)$"});
         put("Footer", new String[] { "^footer\\..*(color|style|bottom|top|background|field|glyph)$"});
         put("Mode", new String[] { "^mode\\..*(color|style|bottom|top|background|field|glyph)$"});
